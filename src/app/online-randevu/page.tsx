    ...
    <>
      <section className="bg-gradient-to-br from-brand-700 to-brand-900 py-16 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-sm font-bold uppercase tracking-wider text-brand-300">Randevu</p>
          <h1 className="mt-2 text-3xl font-extrabold sm:text-4xl">Online Randevu</h1>
          <p className="mt-3 max-w-xl text-lg text-brand-100">
            Gece, hafta sonu ve bayram fark etmez. İstediğiniz saatte randevunuzu alın.
          </p>
        </div>
      </section>
